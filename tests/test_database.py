...
class TestOpportunityDatabase:
    ...
    def test_get_total_count(self, tmp_db):
        ...
        tmp_db.add_opportunity_with_result(
            institution="FINEP", title="E1", link="https://example.com/e1"
        )
        tmp_db.add_opportunity_with_result(
            institution="CNPq", title="E2", link="https://example.com/e2"
        )
    ...
    def test_get_count_by_institution(self, tmp_db):
        ...
        tmp_db.add_opportunity_with_result(
            institution="FINEP", title="E3", link="https://example.com/e3"
        )
    ...
    def test_get_totals_by_institution(self, tmp_db):
        ...
        tmp_db.add_opportunity_with_result(
            institution="FINEP", title="E2", link="https://example.com/e2"
        )
        tmp_db.add_opportunity_with_result(
            institution="CNPq", title="E3", link="https://example.com/e3"
        )
