...
Web scraper for Brazilian research funding opportunities ("editais"). Collects from CAPES, CNPq, FINEP, FAPESB, SETEC, CONFAP, BNDES, MCTI — stores in SQLite, exports to CSV/Excel.
...
Current priority order (config.py `SOURCES`): CAPES, CNPq, FINEP, FAPESB, SETEC, CONFAP, BNDES, MCTI.
